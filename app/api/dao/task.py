...
class TaskDAO:
    ...
    def create_task(user_id, mentorship_relation_id, data):
        ...
        Creates a new task in a mentorship relation,
        if the specified user is already involved in it.
        ...
        Returns:
            ...
            if the task creation was succesful or not as a string.
    ...
    def list_tasks(user_id, mentorship_relation_id):
        ...
        Lists all tasks from a mentorship relation for the specified user
        if the user is involved in a current mentorship relation.
        ...
        Returns:
            A list containing all the tasks one user has
            in a mentorship relation. otherwise, it returns
            a two element list where the first element is,
            a dictionary containing a key 'message' indicating in its value
            if there were any problem finding user's tasks in the specified
            mentorship relation as a string.
        ...
        if not (user_id == relation.mentee_id or
    ...
    def delete_task(user_id, mentorship_relation_id, task_id):
        ...
        Returns:
            A two element list where the first element is,
            a dictionary containing a key 'message' indicating,
            in its value if the task was deleted
            succesfully or not as a string.
            The last element is the HTTP response code.
        """
    ...
    def complete_task(user_id, mentorship_relation_id, task_id):
        ...
        Updates the task that belongs to a user
        who is involved in the specified
        ...
        Returns:
            A two element list where the first element,
            is a dictionary containing a key 'message'
            indicating in its value if the task was set to complete
            succesfully or not as a string.
            The last element is the HTTP response code.
        """
